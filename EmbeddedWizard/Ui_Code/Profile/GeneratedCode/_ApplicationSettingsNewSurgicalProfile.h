...
EW_DEFINE_FIELDS( ApplicationSettingsNewSurgicalProfile, CoreRoot )
  EW_VARIABLE( theme,           ApplicationScreenManager )
...
EW_DEFINE_METHODS( ApplicationSettingsNewSurgicalProfile, CoreRoot )
