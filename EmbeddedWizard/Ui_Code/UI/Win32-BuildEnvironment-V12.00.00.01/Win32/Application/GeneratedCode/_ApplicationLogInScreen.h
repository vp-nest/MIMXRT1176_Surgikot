...
#ifndef _ApplicationLogInScreen_H
#define _ApplicationLogInScreen_H
...
/* Forward declaration of the class Application::LogInScreen */
#ifndef _ApplicationLogInScreen_
  EW_DECLARE_CLASS( ApplicationLogInScreen )
#define _ApplicationLogInScreen_
#endif
...
/* Deklaration of class : 'Application::LogInScreen' */
EW_DEFINE_FIELDS( ApplicationLogInScreen, CoreRoot )
  EW_OBJECT  ( TitleBar,        ApplicationTitleBar )
  EW_OBJECT  ( ButtomBar,       ApplicationButtomBar )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( TopLine,         ViewsLine )
  EW_OBJECT  ( ButtomLine,      ViewsLine )
  EW_OBJECT  ( NumPad,          WidgetNumPad )
  EW_OBJECT  ( LockIcon,        ViewsImage )
  EW_OBJECT  ( H1,              ViewsText )
  EW_OBJECT  ( H2,              ViewsText )
  EW_OBJECT  ( PropertyObserver, CorePropertyObserver )
EW_END_OF_FIELDS( ApplicationLogInScreen )

/* Virtual Method Table (VMT) for the class : 'Application::LogInScreen' */
EW_DEFINE_METHODS( ApplicationLogInScreen, CoreRoot )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationLogInScreen )
...
#endif /* _ApplicationLogInScreen_H */
