...
#ifndef _WidgetNumButton_H
#define _WidgetNumButton_H
...
/* Forward declaration of the class Widget::NumButton */
#ifndef _WidgetNumButton_
  EW_DECLARE_CLASS( WidgetNumButton )
#define _WidgetNumButton_
#endif


/* Deklaration of class : 'Widget::NumButton' */
EW_DEFINE_FIELDS( WidgetNumButton, CoreGroup )
...
EW_END_OF_FIELDS( WidgetNumButton )

/* Virtual Method Table (VMT) for the class : 'Widget::NumButton' */
EW_DEFINE_METHODS( WidgetNumButton, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( WidgetNumButton )
