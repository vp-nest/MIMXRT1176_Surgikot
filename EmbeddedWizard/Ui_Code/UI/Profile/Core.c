...
{
  0x00000118, /* ratio 65.71 % */
  0xB8006700, 0x800A4452, 0x00C60032, 0x0E4003A8, 0xD2003980, 0x1073B000, 0x00888800,
  0x10044CDC, 0x8C1B0006, 0xA0023864, 0x4862F153, 0x6A250E86, 0xA451633C, 0x29129242,
  0x10C8BC22, 0x1D90800E, 0x084CCE49, 0x8FCF0F20, 0x18005D08, 0x1160657A, 0x94D0002A,
  0xA2A4B004, 0x2B0D284F, 0x44888442, 0x4090C6A4, 0x08945EA3, 0x36C222F1, 0x0C54C400,
  0xC8611219, 0x9230778B, 0x65B2AA54, 0xDF178D47, 0xA6A00584, 0x1A96CBE2, 0x28BC92E5,
  0x965B6116, 0xDCA62B26, 0x99A5B668, 0x5EC172A8, 0xAE40021C, 0x003A8443, 0x78823E44,
  0x429B0021, 0x10066A87, 0x00000010, 0x00000000
};

/* Constant values used in this 'C' module only. */
static const XRect _Const0000 = {{ 0, 0 }, { 0, 0 }};
...
static const XRect _Const0004 = {{ -8, -8 }, { 9, 9 }};
static const XStringRes _Const0005 = { _StringsDefault0, 0x0035 };
...
const XPoint EwScreenSize = { 1280, 760 };
...
EW_DEFINE_CLASS( CoreView, XObject, _.VMT, _.VMT, _.VMT, _.VMT, _.VMT, _.VMT, "Core::View" )
  CoreView_Draw,
...
EW_DEFINE_CLASS( CoreGroup, CoreRectView, keyHandlers, _.VMT, _.VMT, _.VMT, _.VMT, 
                 _.VMT, "Core::Group" )
  CoreGroup_Draw,
...
void CoreRoot_ChangeViewState( CoreRoot _this, XSet aSetState, XSet aClearState )
{
  ...
  if ((( aSetState & CoreViewStateVisible ) == CoreViewStateVisible ) || (( aClearState 
      & CoreViewStateVisible ) == CoreViewStateVisible ))
    CoreGroup__InvalidateArea( _this, EwGetRectORect( _this->Super2.Bounds ));

  if ((( aSetState & CoreViewStateAlphaBlended ) == CoreViewStateAlphaBlended ) 
      || (( aClearState & CoreViewStateAlphaBlended ) == CoreViewStateAlphaBlended ))
    CoreGroup__InvalidateArea( _this, EwGetRectORect( _this->Super2.Bounds ));
}
...
void CoreRoot_cursorHoldTimerProc( CoreRoot _this, XObject sender )
{
  ...
  for ( i = 0; i < 10; i = i + 1 )
    if ( _this->cursorTargetView[ EwCheckIndex( i, 10 )] != 0 )
    {
      ...
      if ((CoreRoot)_this->cursorTargetView[ EwCheckIndex( i, 10 )] != _this )
      {
...
XRect CoreRoot_UpdateGE20( CoreRoot _this, GraphicsCanvas aCanvas )
{
  ...
  wholeArea = CoreRoot_UpdateCanvas( _this, aCanvas, _Const0001 );
...
{
  CoreRectView__OnSetBounds( _this, EwNewRect2Point( _Const0001, aSize ));
...
XBool CoreRoot_DriveMultiTouchMovement( CoreRoot _this, XInt32 aFinger, XPoint aPos )
{
  ...
  if ((CoreRoot)_this->cursorTargetView[ EwCheckIndex( aFinger, 10 )] != _this )
  {
  ...
  XPoint aPos )
{
  ...
  if ( aDown && ( _this->cursorTargetView[ EwCheckIndex( aFinger, 10 )] == 0 ))
  {
    ...
    _this->cursorSequelArea[ EwCheckIndex( aFinger, 10 )] = EwMoveRectPos( _Const0004, 
    aPos );
    _this->cursorHittingTime[ EwCheckIndex( aFinger, 10 )] = ticksCount;
    hit = CoreView__CursorHitTest( _this, EwMoveRectPos( _Const0004, aPos ), aFinger, 
    ...
    if ( hit != 0 )
    {
      ...
      _this->cursorTargetView[ EwCheckIndex( aFinger, 10 )] = 0;
      _this->cursorHitOffset[ EwCheckIndex( aFinger, 10 )] = _Const0001;
    }
    else
    {
      _this->cursorTargetView[ EwCheckIndex( aFinger, 10 )] = 0;
...
EW_DEFINE_CLASS( CoreKeyPressHandler, XObject, next, pressCounter, pressCounter, 
                 pressCounter, pressCounter, pressCounter, "Core::KeyPressHandler" )
...
EW_DEFINE_CLASS( CoreCursorHit, XObject, _.VMT, _.VMT, _.VMT, _.VMT, _.VMT, _.VMT, 
                 "Core::CursorHit" )
