...
//  #define EwGfxScreenCopyAlpha8Solid      GfxCopyDriver  // copy mode for alpha8 not supported
...
//  #define EwGfxScreenWarpPerspNative                        GfxWarpDriver // warp with copy mode not supported
//  #define EwGfxScreenWarpPerspNativeFilter                  GfxWarpDriver // warp with copy mode not supported
  #define EwGfxScreenWarpPerspNativeBlend                   GfxWarpDriver
  #define EwGfxScreenWarpPerspNativeFilterBlend             GfxWarpDriver
//  #define EwGfxScreenWarpPerspNativeSolid                   GfxWarpDriver // warp with copy mode not supported
//  #define EwGfxScreenWarpPerspNativeFilterSolid             GfxWarpDriver // warp with copy mode not supported
  #define EwGfxScreenWarpPerspNativeSolidBlend              GfxWarpDriver
  #define EwGfxScreenWarpPerspNativeFilterSolidBlend        GfxWarpDriver

  #ifdef EW_USE_VGLITE_INDEX8
  //  #define EwGfxScreenWarpPerspIndex8                        GfxWarpDriver // warp with copy mode not supported
  //  #define EwGfxScreenWarpPerspIndex8Filter                  GfxWarpDriver // warp with copy mode not supported
    #define EwGfxScreenWarpPerspIndex8Blend                   GfxWarpDriver
    #define EwGfxScreenWarpPerspIndex8FilterBlend             GfxWarpDriver
  //  #define EwGfxScreenWarpPerspIndex8Solid                   GfxWarpDriver // warp with copy mode not supported
  //  #define EwGfxScreenWarpPerspIndex8FilterSolid             GfxWarpDriver // warp with copy mode not supported
    #define EwGfxScreenWarpPerspIndex8SolidBlend              GfxWarpDriver
    #define EwGfxScreenWarpPerspIndex8FilterSolidBlend        GfxWarpDriver
  #endif

//  #define EwGfxScreenWarpPerspAlpha8Solid                   GfxWarpDriver // warp with copy mode not supported
//  #define EwGfxScreenWarpPerspAlpha8FilterSolid             GfxWarpDriver // warp with copy mode not supported
...
//  #define EwGfxScreenWarpPerspRGB565Solid                   GfxWarpDriver // warp with copy mode not supported
//  #define EwGfxScreenWarpPerspRGB565FilterSolid             GfxWarpDriver // warp with copy mode not supported
  #define EwGfxScreenWarpPerspRGB565SolidBlend              GfxWarpDriver
  #define EwGfxScreenWarpPerspRGB565FilterSolidBlend        GfxWarpDriver

//  #define EwGfxScreenWarpAffineNative                       GfxWarpDriver // warp with copy mode not supported
//  #define EwGfxScreenWarpAffineNativeFilter                 GfxWarpDriver // warp with copy mode not supported
  #define EwGfxScreenWarpAffineNativeBlend                  GfxWarpDriver
  #define EwGfxScreenWarpAffineNativeFilterBlend            GfxWarpDriver
//  #define EwGfxScreenWarpAffineNativeSolid                  GfxWarpDriver // warp with copy mode not supported
//  #define EwGfxScreenWarpAffineNativeFilterSolid            GfxWarpDriver // warp with copy mode not supported
  ...
  #ifdef EW_USE_VGLITE_INDEX8
  //  #define EwGfxScreenWarpAffineIndex8                       GfxWarpDriver // warp with copy mode not supported
  //  #define EwGfxScreenWarpAffineIndex8Filter                 GfxWarpDriver // warp with copy mode not supported
    #define EwGfxScreenWarpAffineIndex8Blend                  GfxWarpDriver
    #define EwGfxScreenWarpAffineIndex8FilterBlend            GfxWarpDriver
  //  #define EwGfxScreenWarpAffineIndex8Solid                  GfxWarpDriver // warp with copy mode not supported
  //  #define EwGfxScreenWarpAffineIndex8FilterSolid            GfxWarpDriver // warp with copy mode not supported
...
//  #define EwGfxScreenWarpAffineAlpha8Solid                  GfxWarpDriver // warp with copy mode not supported
//  #define EwGfxScreenWarpAffineAlpha8FilterSolid            GfxWarpDriver // warp with copy mode not supported
