...
#ifndef _ApplicationSettingsMotorTest_H
#define _ApplicationSettingsMotorTest_H
...
/* Forward declaration of the class Application::SettingsMotorTest */
#ifndef _ApplicationSettingsMotorTest_
  EW_DECLARE_CLASS( ApplicationSettingsMotorTest )
#define _ApplicationSettingsMotorTest_
#endif
...
/* Deklaration of class : 'Application::SettingsMotorTest' */
EW_DEFINE_FIELDS( ApplicationSettingsMotorTest, CoreGroup )
  ...
  EW_OBJECT  ( Rectangle5,      ViewsRectangle )
  EW_OBJECT  ( Border1,         ViewsBorder )
  EW_OBJECT  ( Border2,         ViewsBorder )
  EW_OBJECT  ( Border3,         ViewsBorder )
  EW_OBJECT  ( Border4,         ViewsBorder )
  EW_OBJECT  ( Rectangle6,      ViewsRectangle )
  EW_OBJECT  ( Rectangle7,      ViewsRectangle )
  EW_OBJECT  ( Rectangle8,      ViewsRectangle )
  ...
  EW_OBJECT  ( SpinButton,      ApplicationSpinButton )
  EW_OBJECT  ( AddProfileButton, WidgetAddProfileButton )
  EW_OBJECT  ( AddProfileButton1, WidgetAddProfileButton )
  EW_OBJECT  ( AddProfileButton2, WidgetAddProfileButton )
  EW_OBJECT  ( AddProfileButton3, WidgetAddProfileButton )
  EW_OBJECT  ( StatusLabel,     WidgetStatusLabel )
  EW_OBJECT  ( StatusLabel1,    WidgetStatusLabel )
  EW_OBJECT  ( StatusLabel2,    WidgetStatusLabel )
  EW_OBJECT  ( StatusLabel3,    WidgetStatusLabel )
EW_END_OF_FIELDS( ApplicationSettingsMotorTest )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsMotorTest' */
EW_DEFINE_METHODS( ApplicationSettingsMotorTest, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSettingsMotorTest )
...
#endif /* _ApplicationSettingsMotorTest_H */
