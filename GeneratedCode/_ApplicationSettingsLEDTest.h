...
#ifndef _ApplicationSettingsLEDTest_H
#define _ApplicationSettingsLEDTest_H
...
/* Forward declaration of the class Application::SettingsLEDTest */
#ifndef _ApplicationSettingsLEDTest_
  EW_DECLARE_CLASS( ApplicationSettingsLEDTest )
#define _ApplicationSettingsLEDTest_
#endif
...
/* Deklaration of class : 'Application::SettingsLEDTest' */
EW_DEFINE_FIELDS( ApplicationSettingsLEDTest, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationSettingsLEDTest )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsLEDTest' */
EW_DEFINE_METHODS( ApplicationSettingsLEDTest, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSettingsLEDTest )
...
#endif /* _ApplicationSettingsLEDTest_H */
