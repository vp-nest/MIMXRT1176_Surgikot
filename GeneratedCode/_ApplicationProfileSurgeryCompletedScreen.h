...
#ifndef _ApplicationProfileSurgeryCompletedScreen_H
#define _ApplicationProfileSurgeryCompletedScreen_H
...
/* Forward declaration of the class Application::ProfileSurgeryCompletedScreen */
#ifndef _ApplicationProfileSurgeryCompletedScreen_
  EW_DECLARE_CLASS( ApplicationProfileSurgeryCompletedScreen )
#define _ApplicationProfileSurgeryCompletedScreen_
#endif
...
/* Deklaration of class : 'Application::ProfileSurgeryCompletedScreen' */
EW_DEFINE_FIELDS( ApplicationProfileSurgeryCompletedScreen, CoreGroup )
  ...
  EW_OBJECT  ( TimerTxt,        ViewsText )
  EW_OBJECT  ( SelectedModeTxt, ViewsText )
  EW_OBJECT  ( rctButton,       ViewsRectangle )
  EW_OBJECT  ( Text3,           ViewsText )
  EW_OBJECT  ( SelectedModeTxt1, ViewsText )
  EW_OBJECT  ( Image,           ViewsImage )
  EW_OBJECT  ( SimpleTouchHandler, CoreSimpleTouchHandler )
EW_END_OF_FIELDS( ApplicationProfileSurgeryCompletedScreen )

/* Virtual Method Table (VMT) for the class : 'Application::ProfileSurgeryCompletedScreen' */
EW_DEFINE_METHODS( ApplicationProfileSurgeryCompletedScreen, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationProfileSurgeryCompletedScreen )
...
#endif /* _ApplicationProfileSurgeryCompletedScreen_H */
