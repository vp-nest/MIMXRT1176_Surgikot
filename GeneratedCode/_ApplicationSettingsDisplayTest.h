...
#ifndef _ApplicationSettingsDisplayTest_H
#define _ApplicationSettingsDisplayTest_H
...
/* Forward declaration of the class Application::SettingsDisplayTest */
#ifndef _ApplicationSettingsDisplayTest_
  EW_DECLARE_CLASS( ApplicationSettingsDisplayTest )
#define _ApplicationSettingsDisplayTest_
#endif
...
/* Deklaration of class : 'Application::SettingsDisplayTest' */
EW_DEFINE_FIELDS( ApplicationSettingsDisplayTest, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationSettingsDisplayTest )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsDisplayTest' */
EW_DEFINE_METHODS( ApplicationSettingsDisplayTest, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSettingsDisplayTest )
...
#endif /* _ApplicationSettingsDisplayTest_H */
