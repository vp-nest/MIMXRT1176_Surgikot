...
#ifndef _WidgetCustomButton_H
#define _WidgetCustomButton_H
...
/* Forward declaration of the class Widget::CustomButton */
#ifndef _WidgetCustomButton_
  EW_DECLARE_CLASS( WidgetCustomButton )
#define _WidgetCustomButton_
#endif
...
EW_END_OF_FIELDS( WidgetCustomButton )

/* Virtual Method Table (VMT) for the class : 'Widget::CustomButton' */
EW_DEFINE_METHODS( WidgetCustomButton, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( WidgetCustomButton )
