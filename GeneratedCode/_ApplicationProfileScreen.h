...
#ifndef _ApplicationProfileScreen_H
#define _ApplicationProfileScreen_H
...
/* Forward declaration of the class Application::ProfileScreen */
#ifndef _ApplicationProfileScreen_
  EW_DECLARE_CLASS( ApplicationProfileScreen )
#define _ApplicationProfileScreen_
#endif
...
/* Deklaration of class : 'Application::ProfileScreen' */
EW_DEFINE_FIELDS( ApplicationProfileScreen, CoreGroup )
  EW_OBJECT  ( TitleBar,        ApplicationTitleBar )
  EW_OBJECT  ( Rectangle,       ViewsRectangle )
  EW_OBJECT  ( TopLine,         ViewsLine )
  EW_OBJECT  ( ButtomLine,      ViewsLine )
  ...
  EW_OBJECT  ( ProfileButtomBar, ApplicationProfileButtomBar )
  EW_ARRAY   ( ProfileH1,       XString, [4])
  EW_ARRAY   ( ProfileH2,       XString, [4])
  EW_VARIABLE( SelectedItem,    XInt32 )
EW_END_OF_FIELDS( ApplicationProfileScreen )

/* Virtual Method Table (VMT) for the class : 'Application::ProfileScreen' */
EW_DEFINE_METHODS( ApplicationProfileScreen, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationProfileScreen )
...
#endif /* _ApplicationProfileScreen_H */
