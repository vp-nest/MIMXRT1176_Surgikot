...
#ifndef _WidgetEnterButton_H
#define _WidgetEnterButton_H
...
/* Forward declaration of the class Widget::EnterButton */
#ifndef _WidgetEnterButton_
  EW_DECLARE_CLASS( WidgetEnterButton )
#define _WidgetEnterButton_
#endif


/* Deklaration of class : 'Widget::EnterButton' */
EW_DEFINE_FIELDS( WidgetEnterButton, CoreGroup )
...
EW_END_OF_FIELDS( WidgetEnterButton )

/* Virtual Method Table (VMT) for the class : 'Widget::EnterButton' */
EW_DEFINE_METHODS( WidgetEnterButton, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( WidgetEnterButton )
