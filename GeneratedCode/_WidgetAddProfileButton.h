...
#ifndef _WidgetAddProfileButton_H
#define _WidgetAddProfileButton_H
...
/* Forward declaration of the class Widget::AddProfileButton */
#ifndef _WidgetAddProfileButton_
  EW_DECLARE_CLASS( WidgetAddProfileButton )
#define _WidgetAddProfileButton_
#endif


/* Deklaration of class : 'Widget::AddProfileButton' */
EW_DEFINE_FIELDS( WidgetAddProfileButton, CoreGroup )
...
EW_DEFINE_METHODS( WidgetAddProfileButton, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( WidgetAddProfileButton )
...
#endif /* _WidgetAddProfileButton_H */
