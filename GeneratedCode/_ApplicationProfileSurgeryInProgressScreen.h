...
#ifndef _ApplicationProfileSurgeryInProgressScreen_H
#define _ApplicationProfileSurgeryInProgressScreen_H
...
/* Forward declaration of the class Application::ProfileSurgeryInProgressScreen */
#ifndef _ApplicationProfileSurgeryInProgressScreen_
  EW_DECLARE_CLASS( ApplicationProfileSurgeryInProgressScreen )
#define _ApplicationProfileSurgeryInProgressScreen_
#endif
...
/* Deklaration of class : 'Application::ProfileSurgeryInProgressScreen' */
EW_DEFINE_FIELDS( ApplicationProfileSurgeryInProgressScreen, CoreGroup )
  ...
  EW_OBJECT  ( ProfileTxt,      ViewsText )
  EW_OBJECT  ( rctComplete,     ViewsRectangle )
...
EW_END_OF_FIELDS( ApplicationProfileSurgeryInProgressScreen )

/* Virtual Method Table (VMT) for the class : 'Application::ProfileSurgeryInProgressScreen' */
EW_DEFINE_METHODS( ApplicationProfileSurgeryInProgressScreen, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationProfileSurgeryInProgressScreen )
...
#endif /* _ApplicationProfileSurgeryInProgressScreen_H */
