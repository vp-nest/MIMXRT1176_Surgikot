...
#ifndef _ApplicationSettingsScreen_H
#define _ApplicationSettingsScreen_H
...
/* Forward declaration of the class Application::SettingsScreen */
#ifndef _ApplicationSettingsScreen_
  EW_DECLARE_CLASS( ApplicationSettingsScreen )
#define _ApplicationSettingsScreen_
#endif
...
/* Deklaration of class : 'Application::SettingsScreen' */
EW_DEFINE_FIELDS( ApplicationSettingsScreen, CoreGroup )
...
EW_END_OF_FIELDS( ApplicationSettingsScreen )

/* Virtual Method Table (VMT) for the class : 'Application::SettingsScreen' */
EW_DEFINE_METHODS( ApplicationSettingsScreen, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSettingsScreen )
...
#endif /* _ApplicationSettingsScreen_H */
